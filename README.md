...
* **dom_conf** - файл конфигурации с доменами для сервиса;
* **url_conf** - файл конфигруации с ссылками для сервиса;
* **white_conf** - файл со списком доменов, которые следует разбирать по ссылкам.
...
Во-вторых полностью получаем возможность избежать DNS-атаки на РКН. [Подробнее](https://usher2.club/articles/dns-attack-2017/)
